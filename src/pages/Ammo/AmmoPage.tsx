...
const AMMO_DATA: AmmoRound[] = [
  ...
  },
  {
    ...
    effectiveRange: 450,
    bestFor: ['Deer (Rusa)'],
    legalNote: 'Legal for deer — well above .22 minimum. Flat-shooting calibre ideal for Mauritius open slopes and estate clearings.',
    description: 'One of the most popular deer calibres worldwide. The .270 Win fires a slim, high-BC 130gr bullet at high velocity producing a laser-flat trajectory. Core-Lokt\'s tapered jacket peels back uniformly to double calibre diameter — clean, ethical kills at distance.',
    accentColor: '#2d6a4f',
    velocityStat: 94,
    energyStat: 87,
    rangeStat: 90,
  },
  {
    ...
    energy: 2315,
    effectiveRange: 480,
    bestFor: ['Deer (Rusa)', 'Long range'],
    legalNote: 'Legal for deer. High ballistic coefficient resists wind drift — exceptional choice for longer shots across Mauritian hillsides.',
    description: 'The 6.5 Creedmoor has become the benchmark of modern precision hunting. The ELD-X Heat Shield tip prevents tip deformation in flight. Exceptionally high BC (0.625) produces minimal drop and drift. Match-grade accuracy with lethal terminal performance.',
    accentColor: '#1a5c38',
    velocityStat: 76,
    energyStat: 74,
    rangeStat: 96,
  },
  {
    ...
    energy: 3501,
    effectiveRange: 550,
    bestFor: ['Deer', 'Wild Boar (heavy)'],
    legalNote: 'Legal for all game. Overkill for most Mauritian hunting but valid for heavy trophy boar or in thick brush where maximum penetration is needed.',
    description: 'The .300 Win Mag is the definitive long-range heavy-game cartridge. Over 3500 ft-lbs of energy at the muzzle — nearly double that of a .308. Bonded bullet retains 95%+ weight through any barrier. For hunters who refuse to be limited by distance or angle.',
    accentColor: '#14532d',
    velocityStat: 90,
    energyStat: 100,
    rangeStat: 100,
  },
  {
    id: 'rws-8x57js',
    name: 'RWS H-Mantel',
    calibre: '8×57 JS Mauser',
    category: 'rifle',
    weight: '196gr',
    velocity: 2526,
    energy: 2778,
    effectiveRange: 350,
    bestFor: ['Wild Boar', 'Deer'],
    legalNote: 'Legal for all game. A European classic widely available through Mauritian licensed dealers. Heavy bullet excels on tough boar hide and bone.',
    description: 'The 8×57 JS is the old-world workhorse, the cartridge of European battue hunting for over a century. The H-Mantel (half-mantle) design leaves the front third of the core exposed for rapid expansion while the rear half-jacket ensures deep drive. Common in bolt-action Mausers still found on Mauritian estates.',
    accentColor: '#3a7a30',
    velocityStat: 68,
    energyStat: 89,
    rangeStat: 70,
  },
  {
    id: 'norma-7x64',
    name: 'Norma Oryx',
    calibre: '7×64 Brenneke',
    category: 'rifle',
    weight: '170gr',
    velocity: 2756,
    energy: 2869,
    effectiveRange: 420,
    bestFor: ['Deer (Rusa)', 'Wild Boar'],
    legalNote: 'Legal for all game. Extremely popular among French and Belgian hunters — widely seen on Mauritian private estates given the island\'s francophone hunting tradition.',
    description: 'The 7×64 Brenneke is the European equivalent of the .280 Remington — versatile, flat-shooting and hard-hitting. Norma\'s Oryx bonded bullet bonds core to jacket for exceptional weight retention. The choice of generations of estate hunters across the French-speaking hunting world.',
    accentColor: '#2d6a4f',
    velocityStat: 78,
    energyStat: 92,
    rangeStat: 84,
  },
  {
    ...
    energy: 499,
    effectiveRange: 150,
    bestFor: ['Wild Boar (close range)'],
    legalNote: 'Technically legal — centrefire, above .22. However marginal energy for clean deer kills. Best reserved for close-range boar in dense bush where a suppressed setup is used.',
    description: 'Subsonic .300 BLK trades velocity for silence when suppressed. The heavy 220gr bullet delivers controlled expansion at short range inside dense Mauritian ravine cover. A niche choice growing in popularity for quiet boar control on estate land — not a long-range or deer round.',
    accentColor: '#4a5568',
    velocityStat: 20,
    energyStat: 16,
    rangeStat: 28,
  ...
  },
  {
    ...
    calibre: '12 Gauge',
    category: 'shotgun',
    weight: '9 pellets × 8.4mm',
    velocity: 1325,
    energy: 0,
    effectiveRange: 40,
    bestFor: ['Wild Boar'],
    legalNote: 'Legal for boar only — NOT for deer (s.19(1)(c)(ii)). Nine large pellets spread to cover a boar\'s vital zone at close range in thick cover.',
    description: '00 ("double-aught") buckshot fires nine 8.4mm lead balls from a 12-gauge shell. Each pellet carries roughly 200 ft-lbs of energy at the muzzle — nine simultaneous hits at boar distances. Standard defensive and boar-hunting load in estate battue hunting worldwide.',
    accentColor: '#92400e',
    velocityStat: 40,
    energyStat: 55,
    rangeStat: 40,
  ...
  {
    id: '12ga-no75-birdshot',
    name: '12ga No.7½ Birdshot',
    calibre: '12 Gauge',
    category: 'shotgun',
    weight: '32g shot',
    velocity: 1350,
    energy: 0,
    effectiveRange: 25,
    bestFor: ['Quail', 'Partridge'],
    legalNote: 'Legal for small birds. Dense pattern of fine pellets ideal for fast-flushing quail and partridge at Mauritian field drives.',
    description: 'No.7½ shot (2.4mm pellets) packs over 350 pellets into a 32g load, creating a dense cloud at close range. Purpose-built for the quick-flushing small birds of Mauritian agricultural land. Use an improved-cylinder or modified choke for best pattern consistency.',
    accentColor: '#b45309',
    velocityStat: 42,
    energyStat: 15,
    rangeStat: 25,
  },
  {
    ...
    effectiveRange: 120,
    bestFor: ['Wild Boar'],
    legalNote: 'Legal for boar. For use in rifled barrels only — a rifled choke or fully-rifled barrel is required to spin-stabilise the sabot for accuracy beyond 60m.',
    description: 'A sabot slug wraps a sub-calibre projectile in a plastic sabot sleeve, engaging the rifling of a rifled barrel for spin stabilisation. Far more accurate than a Foster or Brenneke slug at range. Delivers rifle-like precision to shotgun-licensed hunters pursuing boar across open Mauritian estates.',
    accentColor: '#a16207',
    velocityStat: 50,
    energyStat: 80,
    rangeStat: 82,
  ...
  {
    id: 'prohibited-tracer',
    name: 'Tracer / Incendiary Ammo',
    calibre: 'Any Calibre',
    category: 'prohibited',
    weight: 'Various',
    velocity: 0,
    ...
    effectiveRange: 0,
    bestFor: [],
    legalNote: 'ILLEGAL — possession and use of tracer or incendiary ammunition is a criminal offence under Mauritian firearms law. Fire hazard in dry Mauritian scrubland is severe.',
    description: 'Tracer and incendiary rounds serve no legitimate hunting purpose. In Mauritius, the combination of strict firearms licensing and dry seasonal vegetation makes these rounds exceptionally dangerous and entirely prohibited. Any possession risks immediate licence revocation and prosecution.',
    accentColor: '#dc2626',
    velocityStat: 0,
    energyStat: 0,
    rangeStat: 0,
  ...
  {
    id: 'prohibited-pistol-deer',
    name: 'Pistol Cartridges (on deer)',
    calibre: '9mm / .45 ACP / etc.',
    category: 'prohibited',
    weight: 'Various',
    velocity: 0,
    energy: 0,
    effectiveRange: 0,
    bestFor: [],
    legalNote: 'ILLEGAL — handgun use for hunting is not permitted under Mauritian hunting licences. Pistol cartridges also lack the energy and penetration for humane deer or boar harvests.',
    description: 'Pistol cartridges such as 9mm Luger or .45 ACP are designed for short-range self-defence, not hunting. Even magnum revolver rounds (.357, .44 Mag) are restricted to specialist use cases not applicable in Mauritius. No hunting licence covers handgun use in the field.',
    accentColor: '#dc2626',
    velocityStat: 0,
    energyStat: 0,
    rangeStat: 0,
